...
downloadArch () {
  ...
  echo "Support coming soon, im too lazy for now..."
  echo "This terminal will autodestruct in 10 seconds"
  sleep 10
}

chooseOS () {
echo "-------Select your linux distribution--------"
echo "(1) piOS/Debian/Ubuntu (2) ArchLinux"
read OS
clear
if [ $OS != "1" ] && [ $OS != "2" ]; then
    clear
...
#Asks user input
menu () {
echo "-------Ninecraft Launcher v0.1 alpha-------"
echo "(1) Install (2) Run (3) Update (4) Advanced (5) Quit"
read menuChoice
