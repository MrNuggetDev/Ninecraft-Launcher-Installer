Only supports Debian/Ubuntu based distributions, i'll add more later. Also, The code handles errors pretty badly, so you might have to double-check everything. 
